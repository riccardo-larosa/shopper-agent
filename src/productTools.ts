...
const toolNode = new ToolNode([execGetRequestTool]);
  ...
  async ({ query }) => {
    ...
    const systemMessage = {
      ...
      content: `
        ...
        and the OpenAPI spec that should be used to answer the query, execute a GET request to complete the task using the right tool.
